...
public class LinuxWebServer extends LinuxServer implements WebContainer {
    ...
    public LinuxWebServer(int identity, String name, String type, Status status) {
    ...
    public boolean equals(Object obj){
        ...
        return this.getIdentity() == linuxWS.getIdentity() && this.getName().equals(linuxWS.getName());
    }
}
